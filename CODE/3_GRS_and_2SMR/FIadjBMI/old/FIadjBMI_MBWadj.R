...
mbw_2_fiadjbmi <- mbw[which(mbw$chr_pos%in%fiadjbmi$chr_pos),] #32/36

#Let's take outliers for those missing:

missing_snps <- fiadjbmi[which(!(fiadjbmi$chr_pos%in%mbw_2_fiadjbmi$chr_pos)),]

#Let's get proxies for all of these fellas in two different ways... and check which ones can we obtain.

setwd("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/CODE/3_2SMR_and_GRS/FIadjBMI/proxies/")

getwd()

LDlinkR::LDproxy_batch(snp = missing_snps$rsID, pop = "EUR", r2d = "r2", append = TRUE, token = "04cad4ca4374")
...
mbw_2_proxies <- mbw[which(mbw$chr_pos%in%proxies_df_clean$Coord),] #247
...
mbw_2_proxies <- mbw_2_proxies[which(mbw_2_proxies$eaf > 0.01 & mbw_2_proxies$eaf < 0.99),] #247

FIadjBMI_proxies_match <- FIadjBMI_proxies[which(FIadjBMI_proxies$chr_pos%in%mbw_2_proxies$chr_pos),] #perfect
mbw_2_proxies_match <- mbw_2_proxies[which(mbw_2_proxies$chr_pos%in%FIadjBMI_proxies_match$chr_pos),]

#Let's get the rsIDs first:

FIadjBMI_proxies_match <- FIadjBMI_proxies_match[order(match(FIadjBMI_proxies_match$chr_pos, mbw_2_proxies_match$chr_pos)),]

length(which(FIadjBMI_proxies_match$chr_pos == mbw_2_proxies_match$chr_pos)) #all match

FIadjBMI_proxies_match$rsid <- mbw_2_proxies_match$RSID
...
outcome_mbw <- mbw[which(mbw$RSID%in%FIadjBMI_independent$rsid),] #29/29
exposure_fiadjbmi <- FIadjBMI_original[which(FIadjBMI_original$chr_pos%in%outcome_mbw$chr_pos),]
...
summary(as.numeric(outcome_mbw$eaf.outcome)) 
...
outcome_mbw$id.outcome <- "Maternal genetic effect on offspring birth weight adjusted by offspring's effect"
outcome_mbw$outcome <- "Maternal genetic effect on offspring birth weight adjusted by offspring's effect"

dat_1_pre <- harmonise_data(exposure_fiadjbmi_pos, outcome_mbw, action = 3) #29: perfect.
...
saveRDS(dat_1_filt_clean, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/3_GRS_output/FIadjBMI/MBWadj/FIadjBMI_MBWadj_merged_df")
...
saveRDS(grs_weighted, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/3_GRS_output/FIadjBMI/MBWadj/FIadjBMI_MBWadj_weighted")
saveRDS(grs_unweighted, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/3_GRS_output/FIadjBMI/FIadjBMI_MBWadj_unweighted")
...
saveRDS(dat_1_filt_steiger, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/FIadjBMI/MBWadj/FIadjBMI_MBWadj_merged_df")

dat_1_filt_steiger <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/FIadjBMI/MBWadj/FIadjBMI_MBWadj_merged_df")
...
saveRDS(mr_results, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/FIadjBMI/MBWadj/FIadjBMI_MBWadj_original")
...
saveRDS(rucker, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/FIadjBMI/MBWadj/FIadjBMI_MBWadj_rucker_test_original")
...
saveRDS(het_Q_Isq, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/FIadjBMI/MBWadj/FIadjBMI_MBWadj_Q_Isq_original")

#3: Sensitivity plots:

dat_1_filt_steiger$labels <- NA

tiff("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/FIadjBMI/MBWadj/FIadjBMI_MBWadj_original.tiff ", units="in", width=10, height=10, res=300)
...
#chr12:66351826: more associated with the outcome! 100% an outlier
#chr3:12351521: PPARG. Also more associated with outcome according to PS. 
#chr1:219668252 (not a detected outlier) but has weird effects. Nonetheless it is not an outlier even in PS!
...
saveRDS(dat_1_post, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/FIadjBMI/MBWadj/FIadjBMI_MBWadj_merged_df_post_outliers")
...
saveRDS(mr_results, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/FIadjBMI/MBWadj/FIadjBMI_MBWadj_post")
...
saveRDS(rucker, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/FIadjBMI/MBWadj/FIadjBMI_MBWadj_rucker_test_post")
...
saveRDS(het_Q_Isq, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/FIadjBMI/MBWadj/FIadjBMI_MBWadj_Q_Isq_post")

#3: Sensitivity plots:

dat_1_post$labels <- NA

tiff("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/FIadjBMI/MBWadj/FIadjBMI_MBWadj_post.tiff ", units="in", width=10, height=10, res=300)
mr_plots(dat_1_post)
dev.off()
...
cluster_1 <- res_em$results$best[which(res_em$results$best$cluster_class == 1),] #9 variants associated
...
saveRDS(mr_results, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/FIadjBMI/MBWadj/FIadjBMI_MBWadj_cluster_1")
...
saveRDS(rucker, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/FIadjBMI/MBWadj/FIadjBMI_MBWadj_rucker_test_clust_1")
...
saveRDS(het_Q_Isq, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/FIadjBMI/MBWadj/FIadjBMI_MBWadj_Q_Isq_clust_1")

#3: Sensitivity plots:

dat_1_cluster_1$labels <- NA

tiff("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/FIadjBMI/MBWadj/FIadjBMI_MBWadj_clust_1.tiff ", units="in", width=10, height=10, res=300)
