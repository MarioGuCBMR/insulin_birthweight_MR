...
fbw_2_CIRadjISI <- fbw[which(fbw$rsID%in%CIRadjISI$snp),] #8/8
...
summary(as.numeric(fbw_2_CIRadjISI$I2)) #we have some of them with huge heterogeneity.
summary(as.numeric(fbw_2_CIRadjISI$`P-het`)) #But only very few with significant heterogenety values.
...
outcome_fbw$id.outcome <- "Fetal Own Birth Weight"
outcome_fbw$outcome <- "Fetal Own Birth Weight"

dat_1_pre <- harmonise_data(exposure_CIRadjISI_pos, outcome_fbw, action = 3) #15: perfect.
...
saveRDS(dat_1_filt_clean, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/3_GRS_output/CIRadjISI/FBW/CIRadjISI_FBW_merged_df")
...
saveRDS(grs_weighted, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/3_GRS_output/CIRadjISI/FBW/CIRadjISI_FBW_weighted")
saveRDS(grs_unweighted, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/3_GRS_output/CIRadjISI/FBW/CIRadjISI_FBW_unweighted")
...
saveRDS(dat_1_filt_steiger, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIRadjISI/FBW/CIRadjISI_FBW_merged_df")

dat_1_filt_steiger <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIRadjISI/FBW/CIRadjISI_FBW_merged_df")
...
mF  = mean(F_) #there is one that has 
...
saveRDS(mr_results, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIRadjISI/FBW/CIRadjISI_FBW_original")
...
saveRDS(rucker, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIRadjISI/FBW/CIRadjISI_FBW_rucker_test_original")
...
saveRDS(het_Q_Isq, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIRadjISI/FBW/CIRadjISI_FBW_Q_Isq_original")

#3: Sensitivity plots:

dat_1_filt_steiger$labels <- NA

tiff("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/sensitivity_plots/IS/CIRadjISI_FBW_original.tiff ", units="in", width=10, height=10, res=300)
...
#All of them are outliers with each other.
#Surprisingly.
...
saveRDS(mr_clust_res, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIRadjISI/FBW/CIRadjISI_FBW_MR_CLUST")
