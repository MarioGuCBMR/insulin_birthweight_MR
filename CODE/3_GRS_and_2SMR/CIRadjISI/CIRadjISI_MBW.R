...
mbw_2_CIRadjISI <- mbw[which(mbw$rsID%in%CIRadjISI$snp),] #8/8
...
summary(as.numeric(mbw_2_CIRadjISI$I2)) #we have some of them with huge heterogeneity.
summary(as.numeric(mbw_2_CIRadjISI$`P-het`)) #But only very few with significant heterogenety values.
...
dat_1_pre <- harmonise_data(exposure_CIRadjISI_pos, outcome_mbw, action = 3) #15: perfect.
...
dat_1_filt[which(!(is.na(dat_1_filt$se.outcome) == FALSE)),]

saveRDS(dat_1_filt_clean, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/3_GRS_output/CIRadjISI/MBW/CIRadjISI_MBW_merged_df")
...
saveRDS(grs_weighted, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/3_GRS_output/CIRadjISI/MBW/CIRadjISI_MBW_weighted")
saveRDS(grs_unweighted, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/3_GRS_output/CIRadjISI/MBW/CIRadjISI_MBW_unweighted")
...
saveRDS(dat_1_filt_steiger, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIRadjISI/MBW/CIRadjISI_MBW_merged_df")

dat_1_filt_steiger <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIRadjISI/MBW/CIRadjISI_MBW_merged_df")
...
summary(F_) #one of them below F <10-

#Which one?

dat_1_filt_steiger[which(F_ < 10),]

#I think we should remove the F <10.
...
saveRDS(mr_results, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIRadjISI/MBW/CIRadjISI_MBW_original")
...
saveRDS(rucker, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIRadjISI/MBW/CIRadjISI_MBW_rucker_test_original")
...
saveRDS(het_Q_Isq, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIRadjISI/MBW/CIRadjISI_MBW_Q_Isq_original")

#3: Sensitivity plots:

dat_1_filt_steiger$labels <- NA

tiff("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/sensitivity_plots/IS/CIRadjISI_MBW_original.tiff ", units="in", width=10, height=10, res=300)
...
saveRDS(mr_clust_res, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIRadjISI/MBW/CIRadjISI_MBW_MR_CLUST")
