...
mbwadjfbw_2_CIRadjISI <- mbwadjfbw[which(mbwadjfbw$RSID%in%CIRadjISI$snp),] #8/8
...
outcome_mbwadjfbw <- mbwadjfbw_2_CIRadjISI %>%
...
outcome_mbwadjfbw$outcome <- "Maternal effect on offsrping Birth Weight adjusted for fetal effect"

dat_1_pre <- harmonise_data(exposure_CIRadjISI_pos, outcome_mbwadjfbw, action = 3) #15: perfect.
...
saveRDS(dat_1_filt_clean, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/3_GRS_output/CIRadjISI/MBWadjFBW/CIRadjISI_mbwadjfbw_merged_df")
...
saveRDS(grs_weighted, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/3_GRS_output/CIRadjISI/MBWadjFBW/CIRadjISI_mbwadjfbw_weighted")
saveRDS(grs_unweighted, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/3_GRS_output/CIRadjISI/MBWadjFBW/CIRadjISI_mbwadjfbw_unweighted")
...
saveRDS(dat_1_filt_steiger, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIRadjISI/MBWadjFBW/CIRadjISI_mbwadjfbw_merged_df")

dat_1_filt_steiger <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIRadjISI/MBWadjFBW/CIRadjISI_mbwadjfbw_merged_df")
...
saveRDS(mr_results, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIRadjISI/MBWadjFBW/CIRadjISI_MBWadjFBW_original")
...
saveRDS(rucker, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIRadjISI/MBWadjFBW/CIRadjISI_MBWadjFBW_rucker_test_original")
...
saveRDS(het_Q_Isq, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIRadjISI/MBWadjFBW/CIRadjISI_MBWadjFBW_Q_Isq_original")

#3: Sensitivity plots:

dat_1_filt_steiger$labels <- NA

tiff("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/sensitivity_plots/IS/CIRadjISI_MBWadjFBW_original.tiff ", units="in", width=10, height=10, res=300)
...
saveRDS(mr_clust_res, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIRadjISI/MBWadjFBW/CIRadjISI_MBWadjFBW_MR_CLUST")
