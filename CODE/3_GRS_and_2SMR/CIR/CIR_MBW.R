...
CIR <- fread("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/CURATED_DATA/Data_4_2SMR/CIR/CLEAN_8_CIR_GRS_SNPs_Manuscript.csv")
...
mbw_2_CIR <- mbw[which(mbw$rsID%in%CIR$SNP),] #8/8
...
#Now we do the same for CIR:

exposure_CIR <- CIR %>%
  select(SNP, A1, A2, EAF, BETA, SE, P)

exposure_CIR$N <- 5318

colnames(exposure_CIR) <- c("SNP", "effect_allele.exposure", "other_allele.exposure",
...
summary(exposure_CIR$eaf.exposure) #perfect!
...
summary(as.numeric(mbw_2_CIR$I2)) #we have some of them with huge heterogeneity.
summary(as.numeric(mbw_2_CIR$`P-het`)) #But only very few with significant heterogenety values.
...
new_a1 <- ifelse(as.numeric(exposure_CIR$beta.exposure) < 0, exposure_CIR$other_allele.exposure, exposure_CIR$effect_allele.exposure)
new_a2 <- ifelse(as.numeric(exposure_CIR$beta.exposure) < 0, exposure_CIR$effect_allele.exposure, exposure_CIR$other_allele.exposure)
new_beta <- ifelse(as.numeric(exposure_CIR$beta.exposure) < 0, (-1)*(exposure_CIR$beta.exposure), exposure_CIR$beta.exposure)
new_eaf <- ifelse(as.numeric(exposure_CIR$beta.exposure) < 0, 1-exposure_CIR$eaf.exposure, exposure_CIR$eaf.exposure)

exposure_CIR_pos <- exposure_CIR

exposure_CIR_pos$effect_allele.exposure <- new_a1
exposure_CIR_pos$other_allele.exposure <- new_a2
exposure_CIR_pos$beta.exposure <- new_beta
exposure_CIR_pos$eaf.exposure <- new_eaf

#Now let's harmonise the data taking that into account:

exposure_CIR_pos$id.exposure <- "CIR"
exposure_CIR_pos$exposure <- "CIR"
...
dat_1_pre <- harmonise_data(exposure_CIR_pos, outcome_mbw, action = 3) #15: perfect.
...
saveRDS(dat_1_filt_clean, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/3_GRS_output/CIR/MBW/CIR_MBW_merged_df")
...
saveRDS(grs_weighted, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/3_GRS_output/CIR/MBW/CIR_MBW_weighted")
saveRDS(grs_unweighted, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/3_GRS_output/CIR/MBW/CIR_MBW_unweighted")
...
saveRDS(dat_1_filt_steiger, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIR/MBW/CIR_MBW_merged_df")

dat_1_filt_steiger <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIR/MBW/CIR_MBW_merged_df")
...
saveRDS(mr_results, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIR/MBW/CIR_MBW_original")
...
saveRDS(rucker, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIR/MBW/CIR_MBW_rucker_test_original")
...
saveRDS(het_Q_Isq, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIR/MBW/CIR_MBW_Q_Isq_original")

#3: Sensitivity plots:

dat_1_filt_steiger$labels <- NA

tiff("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/sensitivity_plots/IS/CIR_MBW_original.tiff ", units="in", width=10, height=10, res=300)
...
saveRDS(dat_1_post, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIR/MBW/CIR_MBW_merged_df_post_outliers")
...
saveRDS(mr_results, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIR/MBW/CIR_MBW_post")
...
saveRDS(rucker_post, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIR/MBW/CIR_MBW_rucker_test_post")
...
saveRDS(het_Q_Isq, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIR/MBW/CIR_mbw_Q_Isq_post")

#3: Sensitivity plots:

dat_1_post$labels <- NA

tiff("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/sensitivity_plots/IS/CIR_mbw_post.tiff ", units="in", width=10, height=10, res=300)
mr_plots(dat_1_post)
dev.off()
...
saveRDS(mr_clust_res, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/CIR/MBW/CIR_MBW_MR_CLUST")
