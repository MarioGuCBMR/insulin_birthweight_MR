...
fbwadjmbw <- fread("C:/Users/zlc436/Desktop/Data_4_GW_analysis/FBWAdj/FBWAdj_curated.txt")
...
fbwadjmbw_2_IR_53 <- fbwadjmbw[which(fbwadjmbw$RSID%in%IR_53$rsID),] #53/53
...
outcome_fbwadjmbw <- fbwadjmbw_2_IR_53 %>%
  select(RSID, ea,nea, eaf, beta, se, p, n_offBW)
...
dat_1_pre <- harmonise_data(exposure_IR_53_pos, outcome_fbwadjmbw, action = 3) #15: perfect.

#Two are palindromic..., but what kind?

dat_1_filt <- dat_1_pre[which(dat_1_pre$remove == FALSE),] #53/53
dat_1_filt <- dat_1_filt[which(dat_1_filt$palindromic == FALSE & dat_1_filt$ambiguous == FALSE | dat_1_filt$palindromic == TRUE & dat_1_filt$ambiguous == FALSE),] #53/53
...
saveRDS(dat_1_filt_clean, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/3_GRS_output/53_IR_Lotta_SNPs/FBWadjMBW/IR_53_FBWadjMBW_merged_df")
...
saveRDS(grs_weighted, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/3_GRS_output/53_IR_Lotta_SNPs/FBWadjMBW/IR_53_FBWadjMBW_weighted")
saveRDS(grs_unweighted, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/3_GRS_output/53_IR_Lotta_SNPs/FBWadjMBW/IR_53_FBWadjMBW_unweighted")
...
saveRDS(dat_1_filt_steiger, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/53_IR_Lotta_SNPs/FBWadjMBW/IR_53_fbwadjmbw_merged_df")

dat_1_filt_steiger <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/53_IR_Lotta_SNPs/FBWadjMBW/IR_53_fbwadjmbw_merged_df")
...
saveRDS(mr_results, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/53_IR_Lotta_SNPs/FBWadjMBW/IR_53_fbwadjmbw_original")

#These are relatively good results but we need to be wary.
...
saveRDS(rucker, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/53_IR_Lotta_SNPs/FBWadjMBW/IR_53_fbwadjmbw_rucker_test_original")
...
saveRDS(het_Q_Isq, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/53_IR_Lotta_SNPs/FBWadjMBW/IR_53_fbwadjmbw_Q_Isq_original")

#3: Sensitivity plots:

dat_1_filt_steiger$labels <- NA

tiff("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/sensitivity_plots/IR/IR_53_fbwadjmbw_original.tiff ", units="in", width=10, height=10, res=300)
...
saveRDS(mr_clust_res, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/53_IR_Lotta_SNPs/FBWadjMBW/IR_53_FBWadjMBW_MR_CLUST")

#Interestingly, most of the variants are in the cluster 1!!

res_em$plots

#Maybe we should have a try??
#Nah, there is nothing here. That is all.
...
dat_1_filt_steiger[which(!(dat_1_filt_steiger$SNP%in%dat_1_cluster_1$SNP)),]
...
mr_results <- mr(dat_1_cluster_1)

saveRDS(mr_results, "C:/Users/zlc436/Desktop/2SMR_4_Hermina/OUTPUT/2SMR/53_IR_Lotta_SNPs/FBWadjMBW/IR_53_fbwadjmbw_cluster_1")
...
saveRDS(het_Q_Isq, "C:/Users/zlc436/Desktop/2SMR_4_Hermina/OUTPUT/2SMR/53_IR_Lotta_SNPs/FBWadjMBW/IR_53_fbwadjmbw_Q_Isq_cluster_1")

#3: Sensitivity plots:

dat_1_cluster_1$labels <- NA

tiff("C:/Users/zlc436/Desktop/2SMR_4_Hermina/OUTPUT/2SMR/53_IR_Lotta_SNPs/FBWadjMBW/IR_53_fbwadjmbw_cluster_1.tiff ", units="in", width=10, height=10, res=300)
