...
fbwadjmbw_2_DI <- fbwadjmbw[which(fbwadjmbw$RSID%in%DI$snp),] #8/8
...
outcome_fbwadjmbw <- fbwadjmbw_2_DI %>%
...
outcome_fbwadjmbw$id.outcome <- "Fetal effects on own birthweight adjusted for maternal effect"
outcome_fbwadjmbw$outcome <- "Fetal effects on own birthweight adjusted for maternal effect"

dat_1_pre <- harmonise_data(exposure_DI_pos, outcome_fbwadjmbw, action = 3) #15: perfect.
...
saveRDS(dat_1_filt_clean, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/3_GRS_output/DI/FBWadjMBW/DI_FBWadjMBW_merged_df")
...
saveRDS(grs_weighted, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/3_GRS_output/DI/FBWadjMBW/DI_FBWadjMBW_weighted")
saveRDS(grs_unweighted, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/3_GRS_output/DI/FBWadjMBW/DI_FBWadjMBW_unweighted")
...
saveRDS(dat_1_filt_steiger, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/DI/FBWadjMBW/DI_fbwadjmbw_merged_df")

dat_1_filt_steiger <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/DI/FBWadjMBW/DI_fbwadjmbw_merged_df")
...
saveRDS(mr_results, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/DI/FBWadjMBW/DI_fbwadjmbw_original")
...
saveRDS(rucker, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/DI/FBWadjMBW/DI_fbwadjmbw_rucker_test_original")
...
saveRDS(het_Q_Isq, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/DI/FBWadjMBW/DI_fbwadjmbw_Q_Isq_original")

#3: Sensitivity plots:

dat_1_filt_steiger$labels <- NA

tiff("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/sensitivity_plots/IS/DI_fbwadjmbw_original.tiff ", units="in", width=10, height=10, res=300)
...
saveRDS(dat_1_post, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/DI/FBWadjMBW/DI_fbwadjmbw_merged_df_post_outliers")
...
saveRDS(mr_results, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/DI/FBWadjMBW/DI_fbwadjmbw_post")
...
saveRDS(mr_clust_res, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/OUTPUT_DATA/4_2SMR_output/DI/FBWadjMBW/DI_FBWadjMBW_MR_CLUST")