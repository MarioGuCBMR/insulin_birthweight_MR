...
betas_ <- c(FIadjBMI_fbw$b, IR_53_fbw$b, FIadjBMI_fbwadjmbw$b, IR_53_fbwadjmbw$b,
           FIadjBMI_mbw$b, IR_53_mbw$b, FIadjBMI_mbwadjfbw$b, IR_53_mbwadjfbw$b,
           FIadjBMI_father$b, IR_53_father$b)

se_ <- c(FIadjBMI_fbw$se, IR_53_fbw$se, FIadjBMI_fbwadjmbw$se, IR_53_fbwadjmbw$se,
           FIadjBMI_mbw$se, IR_53_mbw$se, FIadjBMI_mbwadjfbw$se, IR_53_mbwadjfbw$se,
           FIadjBMI_father$se, IR_53_father$se)
...
exposure_ <-  c("FIadjBMI", "FIadjBMI", "FIadjBMI", "FIadjBMI", "IR_53", "IR_53", "IR_53", "IR_53",
                "FIadjBMI", "FIadjBMI", "FIadjBMI", "FIadjBMI", "IR_53", "IR_53", "IR_53", "IR_53",
                "FIadjBMI", "FIadjBMI", "FIadjBMI", "FIadjBMI", "IR_53", "IR_53", "IR_53", "IR_53",
                "FIadjBMI", "FIadjBMI", "FIadjBMI", "FIadjBMI", "IR_53", "IR_53", "IR_53", "IR_53",
                "FIadjBMI", "FIadjBMI", "FIadjBMI", "FIadjBMI", "IR_53", "IR_53", "IR_53", "IR_53")

method_ <-  c("Egger-FIadjBMI", "Weigthed_Median_FIadjBMI", "IVW_FIadjBMI", "Weighted_Mode_FIadjBMI", "Egger_IR_53", "Weighted_Median_IR_53", "IVW_IR_53", "Weighted_Mode_IR_53",
              "Egger-FIadjBMI", "Weigthed_Median_FIadjBMI", "IVW_FIadjBMI", "Weighted_Mode_FIadjBMI", "Egger_IR_53", "Weighted_Median_IR_53", "IVW_IR_53", "Weighted_Mode_IR_53",
              "Egger-FIadjBMI", "Weigthed_Median_FIadjBMI", "IVW_FIadjBMI", "Weighted_Mode_FIadjBMI", "Egger_IR_53", "Weighted_Median_IR_53", "IVW_IR_53", "Weighted_Mode_IR_53",
              "Egger-FIadjBMI", "Weigthed_Median_FIadjBMI", "IVW_FIadjBMI", "Weighted_Mode_FIadjBMI", "Egger_IR_53", "Weighted_Median_IR_53", "IVW_IR_53", "Weighted_Mode_IR_53",
              "Egger-FIadjBMI", "Weigthed_Median_FIadjBMI", "IVW_FIadjBMI", "Weighted_Mode_FIadjBMI", "Egger_IR_53", "Weighted_Median_IR_53", "IVW_IR_53", "Weighted_Mode_IR_53")
...
dev.off()
  ...
  scale_x_IR_53screte(name="Outcome") +
