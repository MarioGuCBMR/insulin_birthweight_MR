...
gc_results <- fread("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/Manuscript/supplementary_tables_per_method/GC/results_IS_GC.csv")
...
tab3 <- table_base +
  geom_text(aes(y = rev(alphabetical_id), x = 1, label = unlist(sapply(as.numeric(pvals), round_mgu))), size = 2.7,lineheight = 1,
            inherit.aes = TRUE, vjust = 1)
