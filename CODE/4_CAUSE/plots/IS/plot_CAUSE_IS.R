...
cause_results$exposures <- factor(cause_results$exposures, levels = c("CIR", "CIRadjISI", "DI"))
...
tiff("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/Manuscript/figures/CAUSE/IS_CAUSE_plot.tiff", width = 3000, height=1200, res = 300)
