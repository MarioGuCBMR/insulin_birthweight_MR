...
#This is code to run CAUSE for CIRadjISI -> FBWadjMBW
...
#FBWadjMBW <- fread("/home/projects/ku_00095/people/marure/BW_project/CURATED_DATA/DATA_4_CAUSE_&_LHC_MR/FBWAdj_curated.txt")
...
FBWadjFBW <- fread("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Hermina_and_Mario/IR_BW_AIM4/CURATED_DATA/Data_4_GW_analysis/FBWAdj/FBWAdj_curated.txt")
...
CIRadjISI_missing_match_1 <- CIRadjISI_missing[which(CIRadjISI_missing$snp%in%FBWadjMBW_$RSID),] #4! Not too many.
FBWadjMBW_missing_match_1 <- FBWadjMBW_[which(FBWadjMBW_$RSID%in%CIRadjISI_missing$snp),]
...
which(swapping_snps_old_2_new$new_rs%in%FBWadjMBW_$RSID) #1 needs to be changed.
...
FBWadjMBW_missing_match_2 <- FBWadjMBW_[which(FBWadjMBW_$RSID%in%CIRadjISI_missing_match_2$snp),]
...
X <- gwas_merge(CIRadjISI_not_missing, FBWadjMBW_, snp_name_cols = c("chr_pos_37", "chr_pos"), 
...
X_missing_1 <- gwas_merge(CIRadjISI_missing_match_1, FBWadjMBW_missing_match_1, snp_name_cols = c("SNP", "RSID"), 
                beta_hat_cols = c("effect", "beta"), 
                se_cols = c("stderr", "se"), 
                A1_cols = c("effect_allele", "ea"), 
                A2_cols = c("other_allele", "nea"))
...
X_missing_2 <- gwas_merge(CIRadjISI_missing_match_2, FBWadjMBW_missing_match_2, snp_name_cols = c("SNP", "RSID"), 
                        beta_hat_cols = c("effect", "beta"), 
                        se_cols = c("stderr", "se"), 
                        A1_cols = c("effect_allele", "ea"), 
                        A2_cols = c("other_allele", "nea"))
...
saveRDS(X_end, file = "/home/projects/ku_00095/people/marure/BW_project/CODE/4_CAUSE/IS/CIRadjISI/FBWadjMBW/dataframes/X_CIRadjISI_FBWadjMBW.rds")
saveRDS(params, file = "/home/projects/ku_00095/people/marure/BW_project/CODE/4_CAUSE/IS/CIRadjISI/FBWadjMBW/dataframes/params_CIRadjISI_FBWadjMBW.rds")
...
saveRDS(top_vars, "/home/projects/ku_00095/people/marure/BW_project/CODE/4_CAUSE/IS/CIRadjISI/FBWadjMBW/dataframes/pruned_CIRadjISI_FBWadjMBW_res.rds")
...
saveRDS(res, file = "/home/projects/ku_00095/people/marure/BW_project/CODE/4_CAUSE/IS/CIRadjISI/FBWadjMBW/output/res_CIRadjISI_FBWadjMBW.rds")

res_strict <- cause(X=X_end, variants = top_vars, param_ests = params, qalpha = 1, qbeta = 2)

saveRDS(res, file = "/home/projects/ku_00095/people/marure/BW_project/CODE/4_CAUSE/IS/CIRadjISI/FBWadjMBW/output/res_CIRadjISI_FBWadjMBW_strict.rds")
...
tiff("/home/projects/ku_00095/people/marure/BW_project/CODE/4_CAUSE/IS/CIRadjISI/FBWadjMBW/output/res_CIRadjISI_FBWadjMBW_plot.tiff", units="in", width=1200, height=500, res=300)
plot(res, type="data")
dev.off()
