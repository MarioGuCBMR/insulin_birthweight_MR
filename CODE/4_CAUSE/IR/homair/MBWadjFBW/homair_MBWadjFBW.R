...
#This is code to run CAUSE for homair -> MBWadjFBW
...
homair_missing_match_1 <- homair_missing[which(homair_missing$snp%in%MBWadjFBW_$RSID),] #4! Not too many.
MBWadjFBW_missing_match_1 <- MBWadjFBW_[which(MBWadjFBW_$RSID%in%homair_missing$snp),]
...
which(swapping_snps_old_2_new$new_rs%in%MBWadjFBW_$RSID) #3 need to be changed.
...
MBWadjFBW_missing_match_2 <- MBWadjFBW_[which(MBWadjFBW_$RSID%in%homair_missing_match_2$snp),]
...
X <- gwas_merge(homair_not_missing, MBWadjFBW_, snp_name_cols = c("chr_pos_37", "chr_pos"), 
...
X_missing_1 <- gwas_merge(homair_missing_match_1, MBWadjFBW_missing_match_1, snp_name_cols = c("SNP", "RSID"), 
                beta_hat_cols = c("effect", "beta"), 
                se_cols = c("stderr", "se"), 
                A1_cols = c("effect_allele", "ea"), 
                A2_cols = c("other_allele", "nea"))
...
X_missing_2 <- gwas_merge(homair_missing_match_2, MBWadjFBW_missing_match_2, snp_name_cols = c("SNP", "RSID"), 
                        beta_hat_cols = c("effect", "beta"), 
                        se_cols = c("stderr", "se"), 
                        A1_cols = c("effect_allele", "ea"), 
                        A2_cols = c("other_allele", "nea"))
